                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?php echo base_url; ?>CRUDV/insertarDatos.php" method="POST">
                            ...
                            <div class="mb-3">
                                <label for="direccion" class="form-label">Direccion de la viviends</label>
                                <input type="text" class="form-control" id="direccion" name="direccion" placeholder="Direccion de la viviends" required>
                            </div>
                            <div class="mb-3">
