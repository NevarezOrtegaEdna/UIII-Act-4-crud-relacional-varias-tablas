                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo base_url; ?>CRUDP/insertarDatos.php" method="POST">
                            ...
                            <label for="nomProveedor" class="form-label">Nombre del proveedor</label>
                                <input type="text" class="form-control" id="nomProveedor" name="nomProveedor" placeholder="Nombre del proveedor" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="telefono" name="telefono" placeholder="Numero de telefono" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="colonia" name="colonia" placeholder="Ciudad" required>
                            </div>
                            <div class="mb-3">
