                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <th scope="row"><?php echo $resultado['nomProveedor'] ?></th>
                            ...
                            <th scope="row">
                                ...
                                <a href="<?php echo base_url; ?>CRUDP/eliminarDatos.php?Id=<?php echo $resultado['id_proveedor'] ?>" class="btn btn-outline-danger">
